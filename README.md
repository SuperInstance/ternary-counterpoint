...
- **`Pitch`** — core data structure
- **`Voice`** — core data structure
- **`Counterpoint`** — core data structure
- **`CounterpointAnalysis`** — core data structure
- **`Consonance`** — state enumeration
